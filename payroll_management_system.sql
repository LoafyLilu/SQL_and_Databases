...
-- Creating and setting up variables for all tables -- 
...
---- Assigning foreign key relationships to each table --
...
----- Inserting data valyes into each table --
...
--query to see all data in the db for related tables --
...
----- Add 'deductions' table to determine tax or other witholdings taht would be deducted from pay --

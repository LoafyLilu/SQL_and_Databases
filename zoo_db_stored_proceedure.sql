...
/*Creating the stored procedure that builds all tables, values, and assigns all neseccary keys */
...
BEGIN
	...
	INSERT INTO tbl_care
		...
		('care_3', 'human contact pet_subject', 2),
	...
	/* The following queries the database using INNER JOINS. */
